...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            # self.epsilon = math.exp(-0.02* self.trial_number)
            self.epsilon = math.cos(0.005*self.trial_number)
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning= True, alpha = 0.05, epsilon= 0.005)
